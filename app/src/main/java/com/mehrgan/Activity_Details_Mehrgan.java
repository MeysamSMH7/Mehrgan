...
public class Activity_Details_Mehrgan extends AppCompatActivity {
    ...
    private EditText edtAcDe_DorAdd;
    private EditText edtAcDe_DorOD;
    private EditText edtAcDe_DorPD;
    private EditText edtAcDe_DorOS;
    private EditText edtAcDe_NazOD;
    private EditText edtAcDe_NazOS;
    private EditText edtAcDe_NazPD;
...
// toolbar
    ...
    private void findViews() {
        ...
        edtAcDe_DorOD = findViewById(R.id.edtAcDe_DorOD);
        edtAcDe_DorOS = findViewById(R.id.edtAcDe_DorOS);
        edtAcDe_DorPD = findViewById(R.id.edtAcDe_DorPD);
        edtAcDe_DorAdd = findViewById(R.id.edtAcDe_DorAdd);
        edtAcDe_NazOD = findViewById(R.id.edtAcDe_NazOD);
        edtAcDe_NazOS = findViewById(R.id.edtAcDe_NazOS);
        edtAcDe_NazPD = findViewById(R.id.edtAcDe_NazPD);
    ...
    private void setEnabled(boolean set) {
        ...
        edtAcDe_DorAdd.setEnabled(set);
        edtAcDe_DorOD.setEnabled(set);
        edtAcDe_DorPD.setEnabled(set);
        edtAcDe_DorOS.setEnabled(set);
        edtAcDe_NazOD.setEnabled(set);
        edtAcDe_NazOS.setEnabled(set);
        edtAcDe_NazPD.setEnabled(set);
    ...
    private void setDefault(String pk) {
        ...
        edtAcDe_DorAdd.setText(data.dorAdd);
        edtAcDe_DorOD.setText(data.dorOD);
        edtAcDe_DorPD.setText(data.dorPD);
        edtAcDe_DorOS.setText(data.dorOS);
        edtAcDe_NazOD.setText(data.nazOD);
        edtAcDe_NazOS.setText(data.nazOS);
        edtAcDe_NazPD.setText(data.nazPD);
    ...
    private void editData() {
        ...
        data.dorOD = edtAcDe_DorOD.getText().toString();
        data.dorOS = edtAcDe_DorOS.getText().toString();
        data.dorPD = edtAcDe_DorPD.getText().toString();
        data.dorAdd = edtAcDe_DorAdd.getText().toString();
        data.nazOD = edtAcDe_NazOD.getText().toString();
        data.nazOS = edtAcDe_NazOS.getText().toString();
        data.nazPD = edtAcDe_NazPD.getText().toString();
